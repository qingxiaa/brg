#' @title GibbsSampler_pwr
#' @description Gibbs Sampler for posterior sampling in BRIDGE function for power assessment. With smaller sampling iteration to converging
...
#' }
#' @noRd
GibbsSampler_pwr <- function(y, x, beta0, precS, lambda0, theta0){
  n <-length(y)
  X <- cbind(rep(1, n), x)
